...
model = load_model(BASE_DIR / 'models_pred/you_model.h5')
...
def alert():
    data = yf.download(tickers='YOU', period='30d', interval='1d')
...
def pattern():
    data = yf.download(tickers='YOU', period='200d', interval='1d')
